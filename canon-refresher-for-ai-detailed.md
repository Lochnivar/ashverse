...
**Example request:** "The detailed narrative is in `world-building/02-economic-systems.md`, specifically the 'Pettigrew Raid' and 'Court-Martial in the Pines' sections. Would you like to paste those?"
...
**See:** `world-building/06-timelines.md (Atlanta Campaign section)` for locked timeline (Analysis: `analysis/military/atlanta-campaign-ntl-timeline-2025-12-05.md`), `world-building/06-timelines.md (Sherman March section)` for locked timeline (Analysis: `analysis/military/sherman-march-to-appomattox-option-c-modified-2025-12-05.md`).
...
**See:** `world-building/02-economic-systems.md` for detailed raid narratives (Pettigrew Raid, Court-Martial in the Pines, Joint Crackdown).
...
**See:** `world-building/reference/european-war-1939-trigger.md` for full details on 1939 trigger and nuclear timeline.
...
- **See:** `world-building/reference/quartet-symbolism-three-plus-one.md`
...
**See:** `world-building/03-political-systems.md` (USA), `world-building/03-political-systems.md` (CSA), `world-building/03-political-systems.md` (California) for full lists.
...
**See:** `world-building/reference/texas-independence-1877.md`, `world-building/reference/texas-personality-quartet-relations.md`, `world-building/reference/texas-military-institute-1885.md`
...
**See:** `world-building/02-economic-systems.md` for detailed narratives, `analysis/economic/slavery-death-mechanics-analysis-2025-12-05.md` for four-mechanism economic analysis.
...
**See:** `world-building/05-regions-and-nations.md`, `world-building/05-regions-and-nations.md` (writer's reference - "Pacific Venice" mental model).
...
**See:** `world-building/05-regions-and-nations.md (Mormon Deseret section-banking-neutrality.md`
...
**See:** `world-building/02-economic-systems.md (Transcontinental Rail section-routes-bypass.md`
...
**See:** `world-building/08-reference-data.md (Compendium section)` for compendium structure, `characters/staffers/dr-general-michael-j-lockwood.md` for Dr. General Fairfax-Lockwood, `characters/staffers/gervais-rogerus-oscar-kronvoldt.md` for Kronvoldt, `characters/staffers/auto-the-assistant.md` for Auto, `characters/staffers/claudette-beatrice-oswald.md` for Claudette.
...
**See:** `world-building/reference/civil-rights-timeline-1920s-1950s.md` for detailed breakdown.
...
**See:** `world-building/reference/american-antisemitism-vs-european.md` for detailed analysis.

### Racial Dynamics Spectrum (1939 Reference)

**Foundational measurement document:** `world-building/reference/racial-dynamics-spectrum-1939.md`
...
All housed in Institute Hall with iconic Tick/Tock clocks flanking entrance. See `world-building/reference/appomattox-college-annexes-overview.md` for comprehensive documentation.
...
**See:** Individual files: `world-building/05-regions-and-nations.md or world-building/reference/native-super-states-embattled-survivors.md`, `world-building/05-regions-and-nations.md (Mormon Deseret section-banking-neutrality.md`, `world-building/02-economic-systems.md (Transcontinental Rail section-routes-bypass.md`, `world-building/04-military-history.md or world-building/reference/wwi-duration-zimmerman-crisis-explicit-chapter.md`, `world-building/05-regions-and-nations.md or world-building/reference/alaska-purchase-1875-1876.md`, `world-building/02-economic-systems.md or world-building/reference/second-kkk-suppression-economic-motive.md` for detailed analysis of each fix.
...
- **Locked Timelines:** `/world-building/06-timelines.md or world-building/reference/` (locked canon timelines)
...
- **Slavery & Raids:** `/world-building/02-economic-systems.md`
- USA Presidents: `/world-building/03-political-systems.md`
- CSA Presidents: `/world-building/03-political-systems.md`
- California Presidents: `/world-building/03-political-systems.md`
- Native States: `/world-building/05-regions-and-nations.md or world-building/reference/native-super-states-embattled-survivors.md`
- Mormon Deseret: `/world-building/05-regions-and-nations.md (Mormon Deseret section-banking-neutrality.md`
- Transcontinental Rails: `/world-building/02-economic-systems.md (Transcontinental Rail section-routes-bypass.md`
- California-Japan: `/world-building/05-regions-and-nations.md`
- California Diplomacy: `/world-building/05-regions-and-nations.md`
- Compendium Concept: `/world-building/08-reference-data.md (Compendium section)`
...
- **European War 1939 Trigger:** `/world-building/reference/european-war-1939-trigger.md` (Stalin aggression, NOT Hitler)
- **Racial Dynamics Spectrum (1939):** `/world-building/reference/racial-dynamics-spectrum-1939.md` (Foundational reference document - measurement/benchmark of racial equality across all North American shards)
- **Appomattox College:** `/world-building/08-reference-data.md (Appomattox College section)` (Joint USA-CSA military-diplomatic academy, 1909-1939+)
- **Appomattox College Annexes:** `/world-building/reference/appomattox-college-annexes-overview.md` (Master overview of five empirical observatories, 1910-1934)
...
**Recent Updates:**
- December 29, 2025: Quartet Symbolism locked — "Three-Plus-One" model. No four-flag symbol exists. Texas refuses shared symbols with CSA. Tri-Flag stays three flags; Texas flag flown separately at summits. Created `world-building/reference/quartet-symbolism-three-plus-one.md`.
- December 29, 2025: Texas & Appomattox locked — Texas does NOT join Appomattox College. Texas Military Institute (TMI) founded 1885 (24 years before Appomattox). Tri-Flag Concord Badge stays tri-flag (no Texas). Created `world-building/reference/texas-military-institute-1885.md`. Evolution: raw spite (1877-1900) → assertive independence (1900-1919) → dignified maturity (1919-1939).
- December 29, 2025: MAJOR UPDATE — Texas Independence (1877), NTL Cattle Economy, Four-Nation Concord, Texas Personality/Quartet Relations. American Concord now FOUR nations (USA, CSA, California, Texas), not three. Created: `world-building/reference/texas-independence-1877.md`, `world-building/02-economic-systems.md or world-building/reference/ntl-cattle-route-1866-1900.md`, `world-building/05-regions-and-nations.md or world-building/reference/fort-smith-cowtown-1866-1900.md`, `world-building/reference/texas-personality-quartet-relations.md`. Updated all cross-references.
- December 27, 2025: Nuclear weapons projection added (POST-1939, not in series) — Delayed nuclear era (first detonation 1955-1960), California-Japan consortium likely first developer, USSR follows 2-3 years later. This is an "aiming point" for post-series trajectory. Updated `world-building/reference/european-war-1939-trigger.md`.
- December 27, 2025: Book 6 (The Ashes) canon locked — 1939 European War trigger (Stalin's Soviet aggression, NOT Hitler), Civil Rights Timeline (1920s-1950s), American vs. European Anti-Semitism dynamics, Concord-Japan response mechanics. Created new files: `world-building/reference/civil-rights-timeline-1920s-1950s.md`, `world-building/reference/american-antisemitism-vs-european.md`, `world-building/reference/european-war-1939-trigger.md`. Updated master-timeline.md with final scene details.
- December 27, 2025: Six-book structure adopted — The Match (1863-1865), The Flare (1865-1877), The Fire (1878-1894), The Embers (1895-1905), The Quenching (1906-1919), The Ashes (1920-1939). Metaphor progression: Match → Flare → Fire → Embers → Quenching → Ashes (fire lifecycle). Updated `series-overview.md`, `world-building/06-timelines.md or world-building/reference/master-timeline.md`, and this document.
...
- December 19, 2025: Created foundational reference document `world-building/reference/racial-dynamics-spectrum-1939.md` — measurement/benchmark of racial equality spectrum across all North American shards (84-88% plausibility), added cross-reference in CULTURAL/SOCIAL section
- December 19, 2025: Updated Native Super-States Article 4 motivations — reframed from "buffer zone" to "mutual territorial denial" as primary driver (84-88% plausibility), updated `world-building/05-regions-and-nations.md (Native Super-States section)` and canon-refresher cross-reference
...
- **Priority tasks:** Add Priority 1 scenes to `world-building/06-timelines.md (POD Campaign section)part-02-harrisburg-occupation.md` and prepare scene drafts in `edits/`:
...
- **Cross-link tasks:** Ensure `analysis/military/meade-36-hour-delay-telegraph-strategy-2025-12-17.md` is referenced from `README.md`, `compendium/table-of-contents.md`, and `world-building/06-timelines.md (POD Campaign section)part-02-harrisburg-occupation.md` (done where applicable). 
