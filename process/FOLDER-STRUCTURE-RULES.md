...
### `/world-building/reference/` - Supplementary Reference Documents
**Purpose:** Supplementary reference documents (Texas, racial dynamics, annexes, etc.)  
**Rule:** Detailed reference documents that supplement the master files  
**Status:** Reference documents supporting master consolidated files
...
### `/world-building/` Structure (Current - Post-Consolidation)

**Consolidated Master Files:**
- `01-core-foundation.md` - Point of divergence, premise, settings, sovereignty
- `02-economic-systems.md` - Four Horsemen, raids, boycott, glut, shame, rail routes
- `03-political-systems.md` - Presidents, parties, treaties, Lincoln's fate
- `04-military-history.md` - Military strength, WWI, WWII, Zimmerman crisis
- `05-regions-and-nations.md` - Native states, California, Mormon Deseret
- `06-timelines.md` - All major timelines consolidated
- `07-thematic-framework.md` - Scaffolding vs. payload, thematic balance
- `08-reference-data.md` - OTL divergences, tech, Appomattox College

**Reference Subfolder:**
- `/reference/` - Supplementary reference documents (Texas, racial dynamics, annexes, etc.)

**Rule:** Master files contain consolidated locked canon. Reference subfolder contains supplementary detail.
...
**World-Building Root:**
- `01-core-foundation.md` through `08-reference-data.md` - Master consolidated documents
- `pickett-raid-canonical-timeline.md` - Locked timeline detail
- `reference/` subfolder - Supplementary reference documents
...
**Status:** FORMAL RULES - Update when structure changes  
**Last Updated:** December 29, 2025 (Updated post-consolidation)
