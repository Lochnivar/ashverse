...
*[Context: Meade is gone. Who can save the Union?]*

### Hancock Assumes Command

**January 1864**

*[Fully healthy (no Gettysburg wound - battle only one day in NTL), the last great Union commander]*

### Longstreet Digs In

**Spring 1864**

*[Rapidan-Rappahannock line, refuses battle, sends cavalry raids into Kentucky/Missouri]*

### Pickett's Lightning Raid

**June 8-28, 1864**

*[18,000 men, 21 days, burns Chesapeake bridges, shells Fort McHenry, appears before Washington for 48 hours]*

### Hancock Wounded

**July 12, 1864 - On the Susquehanna**

*[The stretcher scene with Armistead during pursuit after Pickett's raid - the last Northern hero falls]*

### The Aftermath

*[What this means - the last hope extinguished]*
...
### Essential Elements
- [ ] Clear time period covered (January-July 1864)
- [ ] Key events with specific dates
- [ ] Hancock's command explained
- [ ] Pickett's raid detailed
- [ ] Hancock's wounding (the stretcher scene)
- [ ] Connection to previous/next chapters
- [ ] Fairfax-Lockwood epigraph commentary
- [ ] At least one memorable footnote

### Optional Elements
- [ ] Character focus (Hancock, Pickett, Armistead)
