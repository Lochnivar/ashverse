# Institute for Border Friction Metrics — Appomattox College Annex

**Established:** 1910 (Tick clock); 1918 (Tock clock and full institute)  
...
**Purpose:** Optional depth document — tracks cross-shard frictions through measurable indicators

---

## Core Concept

The Institute for Border Friction Metrics serves as an empirical tracker of cross-shard tensions through measurable indicators. Its signature feature: two "doomsday-style" clocks tracking different scales of friction — internal (Tick) and global (Tock).
...
**1917 Zimmerman Crisis Influence:**  
Leaked German telegram offering Kentucky/Missouri to CSA exposes global dangers — "oh crap" moment realizing external powers could exploit shard fractures as separate pressure points.

**1918: The Continental Rift Clock ("Tock")**  
Second clock installed post-crisis (June 1918). Broader scope: includes California trade disputes, Native buffer encroachments, Deseret neutrality strains, and foreign influences (e.g., arms shipments). Initial setting: 11:55 (Zimmerman shock pushes it closer to midnight).

**1925-1927: Institute Hall Construction**  
California funds construction of Institute Hall to house all empirical annexes. Tick and Tock are relocated to flank the main entrance as four-faced tower clocks.
...
**Data Sources:**  
Public reports, alumni networks, border logs (anonymized); post-1918 includes foreign trade/intel snippets.

**Annual Report:**  
Tables of incidents, economic costs, clock adjustments. Published without commentary.

**Clock Mechanics:**  
Adjusted January 1 by faculty vote (50/50 USA/CSA, California tie-breaker). Positions published without commentary.

**Example Positions (1939):**  
- Tick (American): 10:35 — habitual détente (symbolic relic)
- Tock (Continental): 9:30 — elevated global tensions (Europe burning again)
...
**Disclaimer Example (1930):**  
> The Institute protests official misuse of Tock positions in CSA diplomatic cables as pretext for foreign alliances. We measure pressures; we do not provoke responses.

---

## Significance and Ironies

- Dual clocks symbolize shift from internal grudges to global vulnerabilities
- California's broader "Tock" subtly reinforces their Pacific insulation
- Tick's near-immobility by 1930s reinforces its "pointless gesture" status
- Tock remains the active one — constant reminder that external pressures are the real threat
- Visual impact: Four faces each ensure the clocks are readable from any direction — constant, inescapable reminders

**Ashverse Fit:**  
Dual clocks illustrate the continent's evolution from internal division to global vulnerability. Peace is measured, not proclaimed — and the measurements are grim reminders that complacency is dangerous.

---

**Plausibility:** 84–87% (ties directly to locked Zimmerman Crisis; dual clocks illustrate shift from internal to external threats; nicknames add human irony)
