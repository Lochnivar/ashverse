# Book 1 Chapter Breakdown Update
...
### Updated Breakdown (Based on Author's Intent):
```
## Chapter Breakdown
*(As a novella, this will be more focused and condensed than a full novel)*

1. Chapter 1: Night, July 1, 1863 - Lee's death on Seminary Ridge, followed by Longstreet's long night of decision-making (fretting, contemplation, and ultimately deciding to withdraw)
2. Chapter 2: Dawn, July 2, 1863 - The withdrawal begins. Army of Northern Virginia withdraws northwest, preserving itself. Opening moves of the next morning.
3. Chapter 3: The War Continues - Different trajectory without Lee, without Gettysburg's defeat
...
### Key Changes:
- **Chapter 1** now includes both Lee's death AND Longstreet's decision-making process (the "long night")
- **Chapter 2** focuses on the withdrawal and morning actions (previously Chapters 4-5 combined)
- Chapters 3-8 cover the rest of the timeline (previously Chapters 6-11, condensed)
- Removed specific timestamps (10:30 p.m., 10:47 p.m., 4:12 a.m.) from chapter titles - keeping it as "Night" and "Dawn" per author's preference
- Removed "Widow Leister house" reference - using "Seminary Ridge" instead

### Notes:
- The structure is more condensed (8 chapters instead of 11), which fits the novella format
- Chapter 1 now contains the crucial decision point (Longstreet's choice to withdraw)
