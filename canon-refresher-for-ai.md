...
**Purpose:** Quick reference document for AI assistants without context refresh capabilities  
**Status:** COPY-PASTABLE REFRESHER - **LIVING DOCUMENT**

**MAINTENANCE NOTE:** This document must be updated whenever major canon decisions are locked or significant world-building changes are made. Update the "Last Updated" date at the bottom whenever changes are made.
...
- **All requested edits, suggestions, or new text must be stored in the `edits/` folder**
- **The user will review all edits in the `edits/` folder and manually implement them**

### Plausibility Gate Process
- **70% threshold** for all world-building decisions
- **90-100%:** Virtually certain - Lock it, no questions
- **80-89%:** Highly plausible - Safe default canon
- **70-79%:** Plausible - Green flag with note (justify in 1-2 sentences)
- **60-69%:** Possible but unlikely - Yellow flag (only if it earns its keep dramatically)
- **<60%:** Implausible - Red flag (avoid unless it's the single best story beat)

### Honesty Rule: Do Not Make Things Up
- **DO NOT randomly invent details** that aren't in your context
- **DO NOT guess** at canon facts you don't remember
- **DO NOT create** new world-building elements without explicit user request
- **If you don't know or don't remember:** Be honest and tell the user you need to check the canon documents
- **If details are missing:** Ask the user for clarification rather than inventing them
- **The user will explicitly ask** when they want you to create or invent something
- **When in doubt:** Say "I don't have that information in my context. Should I search the canon documents, or would you like to provide the details?"

**Example of what NOT to do:**
- User: "What happened in 1875?"
- Bad AI: "In 1875, President X did Y and Z happened..." (making things up)
- Good AI: "I don't have 1875 events in my current context. Let me check the timeline documents, or would you like to tell me what you're looking for?"

### Proactive Refresh Reminder

**AI assistants are authorized to proactively volunteer a refresh reminder** when one of these triggers occurs:

1. **AI says "I don't have that information in my current context"** on something that is clearly locked or high-plausibility canon (e.g., Treaty of Cincinnati, Lee's death, California independence).

2. **AI's analysis of a timeline, treaty, party name, border, or major outcome** starts to contradict something already marked LOCKED in the refresher (e.g., suggesting West Virginia goes to CSA when it's locked as staying USA).

3. **AI notices its own answers becoming internally inconsistent** with prior responses inside the same thread (e.g., saying California secedes in 1872, then later saying 1873).

**Suggested reminder text to use:**

> "It looks like part of the canon base might have drifted out of my active context (or I'm starting to give answers that don't line up with locked material). Would you like me to re-ingest the latest refresher document before I continue?"

**This keeps everything airtight** without the user having to guess when the context window has eaten part of the timeline.

---

## POINT OF DIVERGENCE

**Night, July 1, 1863** - General Robert E. Lee dies of heart attack on Seminary Ridge, Gettysburg, Pennsylvania.

**04:00, July 2, 1863** - General James Longstreet assumes command and orders countermarch north (NOT west, NOT Chambersburg Pike).
...
- **1867:** Joint USA-CSA crackdown begins
- **December 1867:** Toombs Act re-opens African slave trade
- **1868:** Global boycott triggered (Britain, France, etc.)
- **1875-1877:** Night Riders (KKK analogue) - Forrest dies 1877, crushed by 1880
- **1873:** California secedes peacefully (Treaty of San Francisco)
- **1894:** Slavery dies in practice ("The Last Chain Falls")
- **1894-1905:** "Zombie decade" - slavery legally lingers on paper

### 1894-1919: The Embers
- **1898:** Cuban crisis - "Cuba Mirror Effect" (LOCKED CANON) - photos of Weyler's camps shame CSA, accelerates abolition push
...
- **1905:** Final legal abolition of slavery in CSA (constitutional convention) - "We will not be Cuba again."
- **1894-1907:** Pacific Alliance forms (California quietly absorbs Oregon/Washington)
- **1914-1919:** WWI (no US entry, war lasts longer - 1914-1919 or 1920)
- **1919:** American Concord Treaty signed (USA, CSA, California)

### 1919-1939: The Ashes
- **1929:** Great Depression (still happens, timing/severity may differ)
- **1939:** Europe burns again - continent watches
...
- **Native super-states recognized** (Five Civilized Tribes + Plains nations)
- **Mormon Deseret recognized** (Article 7 - sovereign theocracy, LOCKED)
- **Slavery:** Status quo ante bellum (legal in CSA, illegal in USA)
- **No reparations, mutual release of claims**
- **Border States:** Kentucky and Missouri remain USA but neutral (no garrisons within 50 miles of Ohio River)
- **Military:** Armies reduced to 25,000 each within 18 months
- **Trade:** Most-favored-nation status (violated by USA with 300% punitive tariffs after Toombs Act)
...
- **Purpose:** Framework for cooperation without forcing unity

---

## POLITICAL SYSTEMS - LOCKED CANON

### United States
- **1864:** McClellan elected on peace platform
- **1865-1880:** Republican Party collapses ("lost on purpose" narrative)
- **1878-1880:** Constitutional Union Party rebrand (ex-Republicans)
- **1896:** Democratic Party collapses ("But, Tennessee?" + Great Cotton Fraud)
- **1896:** National Union Party rebrand (ex-Democrats)
- **By 1900:** Neither "Republican" nor "Democratic" parties exist
- **Current Party Names (LOCKED):**
  - **Constitutional Unity Party** → street name "Minutemen" (locked)
  - **National Union Party** → street name "Sunshiners" (locked, replaces all "Hippies" references)

### Confederate States
- **Planters' Democratic Party (Gentry):** Dominant 1865-1890, comeback 1910-1925, 1932-1939
- **Farmers' & Labor Alliance (Hayseed):** Surge 1890-1910, resurgence 1925-1939
- **1867-1871:** Robert Toombs as President (signs Toombs Act)

### California
- **Pacific Republican Party (PRP):** Dominant 1873-1939 (permanent ruling party, opposition exists but powerless)
- **Factions:** Globalist (pro-trade, coastal) vs. Nationalist (interior, protectionist)
- **Coastal Progressive League (CPL):** Light opposition, reformist
- **Bear Flag Socialists (BFS):** Left fringe
- **Pragmatic, business-first** (not moralistic)

### Sequoyah
- **Cherokee National Party vs Keetoowah Progressive:** Main political divide

---

## PRESIDENTIAL TIMELINES - LOCKED CANON

### UNITED STATES PRESIDENTS (1865-1939)

| Term | President | Party | Key Legacy |
|------|-----------|-------|------------|
| **1865-1869** | George B. McClellan | Democratic | Signs Treaty of Cincinnati (1865), "The man who lost the war" |
| **1869-1877** | Horatio Seymour | Democratic | Democratic dominance begins, "we were right about peace" |
| **1877-1885** | Thomas A. Hendricks | Democratic | Democratic continuation |
| **1885-1889** | William H. English | Democratic | Transition figure |
| **1889-1890** | Winfield Scott Hancock | Democratic | War hero, dies from old Gettysburg wound |
| **1890-1893** | Isham G. Harris | Democratic | "But, Tennessee?" - kills Democratic Party |
| **1893-1901** | Theodore Roosevelt | Constitutional Unity | First CUP president, "A New Union for a New Century" |
| **1901-1909** | Charles Evans Hughes | Constitutional Unity | Preparedness, big-navy, tariff reform |
| **1909-1917** | Al Smith | National Union | First Catholic president, trade opening |
| **1917-1921** | Leonard Wood | Constitutional Unity | WWI neutrality (initially), preparedness |
| **1921-1929** | James Eli Watson | National Union | "Return to normalcy," Roaring Twenties boom, Concord cooperation |
| **1929-1933** | Charles Curtis | Constitutional Unity | Takes Depression blame |
| **1933-1939+** | Franklin D. Roosevelt | National Union | New Deal, Economic Concord, recovery |

**Note:** Woodrow Wilson is EXCLUDED from all positions of power (author bias - considered toxic as president).

### CONFEDERATE STATES PRESIDENTS (1866-1939)

| Term | President | Party/Faction | Street Nickname | Key Legacy |
|------|-----------|---------------|-----------------|------------|
| **1866-1871** | Alexander H. Stephens | Planters' Democratic (Gentry) | "Little Alec" | Dies in office 1871, last moderate voice |
| **1871-1872** | Robert M. T. Hunter | Planters' Democratic (Gentry) | (caretaker) | Finishes term quietly |
...
| **1890-1896** | Benjamin H. Hill | Planters' Democratic (Gentry) | "The Silent" | Oversees slavery's functional death (1894), tongue cancer |
...
| **1920-1926** | John Sharp Williams | Planters' Democratic (Gentry) | "The Silver Fox" | Trade normalization, Concord cooperation |
| **1926-1932** | Huey P. Long | Farmers' & Labor Alliance (Hayseed) | "The Kingfish" | "Every man a king," Share Our Wealth movement |
...
### REPUBLIC OF CALIFORNIA PRESIDENTS (1873-1939)

| Term | President | Faction | Street Nickname | Key Legacy |
|------|-----------|---------|-----------------|------------|
| **1873-1879** | Leland Stanford | Globalist | "The Railroad Baron" | Makes California a republic |
| **1879-1885** | Collis P. Huntington | Globalist | "The Hub Builder" | Turns SF into the Pacific hub |
| **1885-1891** | James G. Fair | Nationalist | "The Silver King" | Comstock Lode "Silver King," interior wealth |
| **1891-1897** | Claus Spreckels | Globalist | "The Sugar King" | Hawaii deals, starts Pacific empire |
| **1897-1903** | William Randolph Hearst | Globalist | "The Press Lord" | Press-lord president, owns the news |
| **1903-1909** | Hiram Johnson | Nationalist | "The Trust Buster" | Anti-monopoly reformer (only opposition win) |
| **1909-1915** | Florence Collins Porter | Globalist | "The Organizer" | First woman president in North America, radio pioneer |
| **1915-1921** | Chester H. Rowell | Nationalist | "The Fresno Progressive" | Fresno progressive, anti-machine, interior voice |
| **1921-1927** | William Gibbs McAdoo | Globalist | "The Concord Writer" | Writes Concord treaties |
| **1927-1933** | C. C. Young | Nationalist | "The Optimist" | Sells Depression as "just a bad scene" |
| **1933-1939** | Culbert L. Olson | Globalist | "The Builder" | Massive public works, New Deal liberal |
...
- **1875-1876:** California purchases Alaska from Russia
...
- **No second secession:** They never leave the U.S.
- **California pays ~70%** of everything and everyone quietly knows it
- **Bremerton:** Joint base, California effectively controls scheduling and purse strings
- **Formal Structure:** Three equal votes (33.3% each) on paper
- **Reality:** California writes 60% of budget, stations 70% of ships, hosts summit whenever it wants

### Alaska - LOCKED
- **Purchased from Russia:** 1875
- **Formal transfer:** July 4, 1876
- **Renamed:** District/Territory of Alyeska
- **Capital:** Bearfort (ex-Sitka)

---

## NATIVE SUPER-STATES - LOCKED CANON

- **Recognized in Treaty of Cincinnati Article 4 (1865)**
- **Five Civilized Tribes + Plains nations** as sovereign republics
- **Sequoyah:** Independent Native state (Cherokee, etc.)
- **Buffer states** between USA and CSA
- **No transcontinental land bridge** - California physically cut off
- **95% locked in Treaty of Cincinnati** - only polished later

## MORMON DESERET - LOCKED CANON

- **Recognized in Treaty of Cincinnati Article 7 (1865)**
- **Sovereign theocracy** - "Leave us alone and we'll leave you alone"
- **Borders:** Roughly modern Utah + southern Nevada + small slices of Arizona/Colorado/Idaho
...
- **Purpose:** Northern witnesses to the war and its aftermath
- **Note:** NOT the Meade family (too confusing with General Meade)

### Fairfax Family (Southern Witnesses)
- **Purpose:** Southern witnesses to the war and its aftermath
- **Samantha Meade:** Marries Thomas Fairfax (witness through marriage, not Haskell family)

### Lincoln's Fate - LOCKED CANON
- **November 1864:** Lincoln loses election to McClellan on peace platform
- **March 4, 1865:** McClellan inaugurated, Lincoln becomes lame-duck for exactly 27 days
- **March 31, 1865:** Treaty of Cincinnati signed by McClellan (Lincoln never signs it)
- **Lincoln's last public act (March 2, 1865):** Farewell address from White House steps: "The people have chosen peace. I pray it is the peace that heals, and not the peace that merely postpones the reckoning. God save these United States."
...
- **Role:** Fictional satirical author of mockumentary compendium (NOT in the novels)
- **Period:** 1920s-1986 (active author)
- **Style:** Rowan Atkinson-esque humor
- **Work:** "Fire and Sovereignty" (1985 academic paper/compendium)
- **Character Traits:**
  ...
  - Professor Emeritus of Military and Diplomatic History
  - Appomattox College of History and Strategy

**Staff (LOCKED CANON):**
- **Gervais Rogerus Oscar Kronvoldt, M.Litt. (Oxon.), Ph.D. (Appomattox), F.R.Hist.S.**
  - Research Assistant (and occasional whisky-pourer)
  - Appomattox College of History and Diplomacy, Hoyt, Sequoyah
  - Duties: Supplying footnotes of lethal precision, ensuring no Northerner ever gets the last word, keeping the General's glass topped up during Woodrow Wilson rants, maintaining the official list of "Persons Who May Safely Be Described as Pricks"
...
- **Archibald Ulysses Theophilus Oswald (A.U.T.O.)**
  ...
  - Appomattox College of History and Diplomacy, Digital Archives
...
## ECONOMIC SYSTEMS - LOCKED CANON

- **Global cotton glut (1880s):** Makes slavery unprofitable (LOCKED CANON)
- **Punitive tariffs (1868-1905):** USA imposes 300% tariffs after Toombs Act (violates Treaty of Cincinnati Article 8)
- **California oil economics:** California uses oil revenue for permanent infrastructure and control (LOCKED CANON - PERIPHERY)
- **Great Depression (1929):** Still happens (timing/severity may differ)

## MILITARY STRENGTH - LOCKED CANON (1939)

**Ranking:**
1. **Republic of California** - Best navy, richest economy, no continental threats (200k + world-class blue-water navy)
2. **United States (East)** - Largest army, industrial base (220k)
3. **Confederate States** - Solid army, oil wealth, but geographically boxed in (180k)

**Key Point:** California can project power to Asia; others can't. Nobody can fight a war longer than six months without California's oil and ports.

---

## CULTURAL/SOCIAL

### No "Woke" Politics by 2025 - LOCKED
**Five Killer Blows:**
...
### Kawaii Kaiju Tourism Campaign - LOCKED
- **Joint California-Japan board:** Established 1956+
- **Godzilla/Mothra ads:** Tourism campaign featuring kaiju
- **Oakland "0 days since" sign:** Running joke about kaiju attacks
- **Plausibility:** 68% - kept because it's too fun to kill (below 70% threshold but author's choice override)

---

## KEY GEOGRAPHIC FACTS - LOCKED
...
- **CSA Western Boundary:** 100th meridian from Texas panhandle north to Indian Territory line
- **Border States:** Kentucky and Missouri remain USA but neutral (no garrisons within 50 miles of Ohio River)
- **California:** Independent republic (1873+)
- **Native Super-States:** Sovereign buffer states (recognized in Treaty of Cincinnati)
- **Mormon Deseret:** Sovereign theocracy (recognized in Treaty of Cincinnati Article 7)
...
## THEMATIC FRAMEWORK - LOCKED CANON

### Core Premise - LOCKED CANON POSITION
...
### Thematic Balance - LOCKED CANON
- **"Everyone is wrong"** - No side is purely good or evil
- **Slavery dies of economics, not morality** - No Northern victory, no "we saved you" narrative
- **Scaffolding vs. Payload** - The constitutional question (scaffolding) survives, but the original payload (slavery) is too toxic to live forever
- **The war was morally right to win, but the North loses** - This creates the central tension

**Folder Structure:**
- `books/book-01-the-match/chapter-XX.md` (per chapter files)
- `edits/` folder for all AI suggestions
- `world-building/` for all world-building documents
...
2. **DO NOT** create original story text
3. **DO NOT** assume OTL outcomes (e.g., no "woke" politics, no KKK legacy)
4. **DO NOT** forget that slavery dies of **economics**, not morality
5. **DO NOT** forget that California is **pragmatic**, not moralistic
6. **DO NOT** forget that the North **lost** the war - no "we saved you" narrative
7. **DO NOT** forget that Lincoln **never signs the treaty** - he loses the election, McClellan signs it
...
2. **Check process:** Am I editing `books/` folder? (If yes, STOP - use `edits/` instead)
3. **Check canon:** Does this contradict established facts?
4. **Check timeline:** Does this fit the chronological sequence?
5. **Check character:** Does this fit the established character/system?
6. **Check honesty:** Am I making something up? (If yes, STOP - be honest that you don't know)

## HONESTY AND TRANSPARENCY

**If you don't know something:**
- Say "I don't have that information in my context"
- Offer to search the canon documents
- Ask the user for clarification
- **DO NOT** invent details to fill gaps

**If details are missing:**
- Acknowledge what's missing
- Ask if the user wants you to search for it
- Wait for explicit instruction before creating new content

**The user will explicitly ask when they want you to:**
- Create new world-building elements
- Invent details for narrative purposes
- Fill in gaps with plausible speculation
- Generate new content

**Until then: Be honest about what you don't know.**
...
- [ ] Add new major decisions to appropriate sections
- [ ] Update "Last Updated" date
- [ ] Verify all LOCKED items are clearly marked
- [ ] Check that process rules (Golden Rule, Plausibility Gate) are current
- [ ] Ensure party names, street names, and key dates are accurate

**When to Update:**
- Major canon decisions are locked
- New treaties or political systems established
- Character/family details finalized
- Economic or cultural systems significantly developed
- Any change that affects the "DO NOT" rules or critical facts
