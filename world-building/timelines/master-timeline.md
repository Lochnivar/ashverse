...
**Last Updated:** December 9, 2025 - Integrated all locked timelines, asserted Hawaii/WWI timelines, reorganized folder structure

**Detailed Timeline Documents:**
- **Northern Collapse Sequence:** `world-building/timelines/northern-collapse-1863-1865.md` (LOCKED CANON - 91% plausibility)
- **Gettysburg Campaign:** `world-building/timelines/gettysburg-master-timeline.md` (CONSOLIDATED - Master Reference)
- **Atlanta Campaign:** `world-building/timelines/atlanta-campaign-1864-1865.md` (LOCKED CANON - 87% plausibility, Analysis: `analysis/military/atlanta-campaign-ntl-timeline-2025-12-05.md`)
- **Sherman's March to Appomattox:** `world-building/timelines/sherman-march-appomattox-1865.md` (LOCKED CANON - 94% plausibility, Analysis: `analysis/military/sherman-march-to-appomattox-option-c-modified-2025-12-05.md`)
- **Cuba Mirror Effect:** `world-building/timelines/cuba-mirror-effect-timeline.md` (LOCKED CANON - integrated into The Fire section)
- **Hawaii Timeline:** `world-building/timelines/hawaii-timeline.md` (ASSERTED - 9/10 likelihood, not locked)
- **WWI Timeline:** `world-building/timelines/wwi-timeline.md` (ASSERTED - integrated into The Embers section, not locked)
...
| 1896–1905 | **Cuba Mirror Effect** – Six-year drip of images forces CSA to see Weyler's camps as mirror of own past (LOCKED CANON - see `world-building/timelines/cuba-mirror-effect-timeline.md`) |
...
| 1914–1919 | European War (WWI analogue) – starts on schedule (July-August 1914), lasts longer (5 years vs 4), ends in exhaustion stalemate. No U.S. entry in 1917 – fractured U.S. has no army/money/political will (ASSERTED - see `world-building/timelines/wwi-timeline.md`) |
...
| 1893–1898 | **Hawaii Overthrow** – American planters overthrow Queen Liliʻuokalani (1893), Republic of Hawaii declared (1894). U.S. too weak to annex (no Spanish-American War). Japan circles (ASSERTED - see `world-building/timelines/hawaii-timeline.md`) |
| 1905–1915 | **Hawaii Under Japanese Protection** – Japan makes move: quiet protectorate → full annexation. Hawaii becomes Japanese territory. Pearl Harbor becomes Japanese fleet anchorage (ASSERTED - 9/10 likelihood) |
